...
class Mutual_fundList(admin.ModelAdmin):
    list_display = ('customer','fund_name', 'units', 'net_asset_value')
    list_filter = ('customer','fund_name')
    search_fields = ('customer','fund_name')
    ordering = ['customer']

admin.site.register(Customer, CustomerList)
admin.site.register(Investment, InvestmentList)
admin.site.register(Stock, StockList)
admin.site.register(Mutual_fund,Mutual_fundList)
