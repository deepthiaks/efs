...
urlpatterns = [
    ...
    url(r'^mutual_fund/$', views.mutual_fund_list, name='mutual_fund_list'),
    url(r'^mutual_fund/(?P<pk>\d+)/delete/$', views.mutual_fund_delete, name='mutual_fund_delete'),
    url(r'^mutual_fund/(?P<pk>\d+)/edit/$', views.mutual_fund_edit, name='mutual_fund_edit'),
    url(r'^mutual_fund/create/$', views.mutual_fund_new, name='mutual_fund_new'),
]
